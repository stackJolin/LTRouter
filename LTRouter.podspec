...
Pod::Spec.new do |s|
  s.name             = 'LTRouter'
  s.version          = '0.1.0'
  s.summary          = 'A short description of LTRouter.'
...
TODO: Add long description of the pod here.
  ...
  s.homepage         = 'https://github.com/stackjolin/LTRouter'
  # s.screenshots     = 'www.example.com/screenshots_1', 'www.example.com/screenshots_2'
  s.license          = { :type => 'MIT', :file => 'LICENSE' }
  s.author           = { 'stackjolin' => 'zhuhoulin@windimg.com' }
  s.source           = { :git => 'https://github.com/stackjolin/LTRouter.git', :tag => s.version.to_s }
